  ...
  return (
    <Wrapper>
      ...
      <TextComponent>
        ...
        tworzenia i nieustannym dążeniem do doskonałości. Nasza historia zaczyna
        się od marzenia o budowaniu nie tylko budynków, ale także społeczności.
        <br />
        <br />
        Nasza siedziba znajduje się w sercu Polski - w{" "}
        <TextImportant>Warszawie</TextImportant>, ale{" "}
        <TextLink to="/projects">nasze projekty</TextLink> można znaleźć w całym
        kraju. Przez lata, nasza ekipa zdobyła doświadczenie w każdym aspekcie
        budownictwa, od projektowania po realizację. W{" "}
        ...
        budynki powinny być więcej niż tylko strukturami - powinny być miejscem,
        gdzie ludzie mogą żyć, pracować i cieszyć się życiem.
        <br />
        ...
        <br />
        <br />
        Zapraszamy do odwiedzenia <TextLink to="/blog">naszego bloga</TextLink>,
        gdzie znajdziesz więcej informacji na temat naszej firmy, naszych
        projektów i naszej misji. W <TextHighlight>Constructony</TextHighlight>,
        budujemy przyszłość razem z Tobą.
      </TextComponent>
    </Wrapper>
  );
}
