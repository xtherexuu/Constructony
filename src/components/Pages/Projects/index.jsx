...
import { Project, ProjectHeading, ProjectImage, Wrapper } from "./styled";
    ...
    <Wrapper>
      ...
      <Project>
        ...
        <TextComponent>
          ...
          <br />
          Znajduje się ona około 70 kilometrów na zachód od Wrocławia, w gminie
          Jawor, na terenie Wałbrzyskiej Specjalnej Strefy Ekonomicznej.
          <br />
          <br />
          Zakład, działający w ramach nowo powstałej spółki{" "}
          <TextHighlight>Mercedes-Benz Manufacturing Polska</TextHighlight>,
          specjalizuje się w produkcji czterocylindrowych silników benzynowych i
          wysokoprężnych, oraz baterii elektrycznych do samochodów osobowych
          marki Mercedes-Benz.
          <br />
          <br />
      ...
      <Project>
        ...
        <TextComponent>
          ...
          zlokalizowany na warszawskiej Woli, na rogu ulicy Chmielnej oraz alei
          Jana Pawła II.
          <br />
          <br />
